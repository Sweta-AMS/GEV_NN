...
_This repository contains code for reproducing the results in "Paper-Fast-parameter-estimation-of-Generalized-Extreme-Value-distribution-using-Neural-Networks." _
